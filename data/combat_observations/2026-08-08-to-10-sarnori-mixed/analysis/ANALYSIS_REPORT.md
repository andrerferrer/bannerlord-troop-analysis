...
|---|---|---|---:|---:|---:|---:|---|
| field | Sarnori Spider [T6] | `sarnor_spider` | 2 | 107 | — | — | insufficient_evidence |
| field | Sarnori Master Javelinier [T5] | `sarnor_master_javelinier` | 3 | 71 | — | — | insufficient_evidence |
| field | Sarnori Master Spearman [T5] | `sarnor_master_spearman` | 2 | 21 | — | — | insufficient_evidence |
...
| siege_attack | Sarnori Spider [T6] | `sarnor_spider` | 3 | 125 | — | — | insufficient_evidence |
| siege_attack | Sarnori Master Javelinier [T5] | `sarnor_master_javelinier` | 3 | 115 | — | — | insufficient_evidence |
| siege_attack | Sarnori Master Spearman [T5] | `sarnor_master_spearman` | 1 | 25 | — | — | insufficient_evidence |
| siege_attack | Sarnori Javelineer [T3] | `sarnor_javelinier` | 2 | 5 | — | — | insufficient_evidence |
| siege_attack | Sarnori Elite Javelinier [T4] | `sarnor_elite_javelinier` | 3 | 24 | — | — | insufficient_evidence |
