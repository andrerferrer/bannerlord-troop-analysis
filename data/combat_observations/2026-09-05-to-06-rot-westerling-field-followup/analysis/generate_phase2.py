...
BATCH_ID = "2026-09-05-to-06-rot-westerling-field-followup"
TRACK = "realm_of_thrones"
GAME_VERSION = "1.4.x"
PIPELINE_VERSION = "0.4.0"
SCHEMA_VERSION = "2.0.0"
NORMALIZATION_COMMIT = "0fe6776be7ea4726ea902308d9c296c3faa8ad8d"
IDENTITY_AUDIT_SHA256 = "63ea983998e25aa0e6f8c0747bf42e44440f695bbe1fec717074e7ba64e42810"
SOURCE_SHA256 = "9280150e051a07990a5063df77853eec71e623acaba780048e13410587bcb3bd"
SOURCE_SIZE = 42_428_790
BUNDLE_SHA256 = "1ba4c3c28db029bda23f57a6c830c0d57107b9a6e89dd1b1258a70514f56222a"
BUNDLE_SIZE = 21948
BUNDLE_MEMBERS = 18
GATE_BATTLES = 5
GATE_DEPLOYED = 20
BOOTSTRAP_REPETITIONS = 10_000
FOCUS = ("Westerling Hedgeknight",)
...
def extract_bundle():
    ...
    if len(parts)!=1: raise ValueError(f'expected 1 bundle part, found {len(parts)}')
...
def main():
    ...
    if len(battles)!=20 or len(rows)!=217 or len(occurrences)!=283: raise ValueError('unexpected normalized counts')
    for r in rows:
    ...
    if Counter(b['battle_context'] for b in battles.values())!={'field':20}: raise ValueError('context count mismatch')
