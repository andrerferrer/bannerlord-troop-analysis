...
- The sole failure is `test_staged_path_substitution_fails_and_restores_target`, the same pre-existing assertion-message mismatch documented by the preceding merged Phase 2 batch; this PR does not modify that audit implementation or test.
