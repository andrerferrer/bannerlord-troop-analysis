# Theoretical analysis — `realm_of_thrones` / `export_20260729_025002`
...
- Soldier/troop role rows scored: **1232**
- Entrypoint: `scripts/scoring/generate_vanilla_role_scores.py` (unchanged scoring logic)

## Sanity / anchors

Priority empirical validation targets for this track (not cross-track controls):
